        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">ตั้งรหัสผ่านใหม่</h1>
                    <div class="row">
                                    ...
                                    <form class="user" method="POST" action="update-Password.php">
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="password" class="form-control form-control-user" id="changPassword" name="changPassword"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <button type="submit" class="btn btn-success btn-user btn-block" >ยืนยัน</button>  
                                            </div>
                                        </div>
