                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลรายการของที่สามารถเบิกได้</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="form-detailtakeSouvenir.php?souID=<?php echo $result_Product['sou_id'];?>" class="btn btn-success btn-circle">
