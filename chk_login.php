...
<?php
	...
	$check_log = mysqli_query($con,"select * from tb_users where user_email ='$em' and user_password ='$pwd'");
			...
			while ($data = mysqli_fetch_array($check_log) ) 
				{
					...
					$now_login = $date_time;
					$sql_login = mysqli_query($con,"update tb_users set last_login='$last_login',now_login='$now_login' where user_email='$em' ");
