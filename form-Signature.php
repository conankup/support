                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="user" method="POST" action="save-Signature.php" enctype="multipart/form-data" name="frmUpload" id="frmUpload">                                        
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="file" class="form-control" id="imgSignature" name="imgSignature" required>
                                            </div>
                                        </div>
                                        <input type="text" name="oldUID" value="<?php echo $userID; ?>">
