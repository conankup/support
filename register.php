                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="save_register.php" oninput='RePWD.setCustomValidity(RePWD.value != InPWD.value ? "รหัสผ่านไม่ตรงกัน" : "")'>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" name="InPWD" placeholder="Password" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" name="RePWD" placeholder="Repeat Password" required>
                                    </div>
                                </div>
